...
export default function AppLayout() {
  return (
    <SidebarProvider defaultOpen>
      <div className="nexo-shell min-h-screen flex w-full bg-background">
        <AppSidebar />
        <div className="flex-1 flex flex-col min-w-0">
          <AppHeader />
          <main className="flex-1 overflow-x-hidden p-4 animate-fade-in-up md:p-6 lg:p-8">
            <AppRenderBoundary
              fallback={(
                <div className="flex min-h-[60vh] items-center justify-center">
                  <Card className="max-w-lg px-6 py-5 text-sm text-muted-foreground">
