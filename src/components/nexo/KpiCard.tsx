...
export function KpiCard({ label, value, delta, icon: Icon, tone = "primary" }: KpiCardProps) {
  ...
  return (
    <Card className="p-5 hover:shadow-elegant transition-smooth border-border/60 group">
      <div className="flex items-start justify-between mb-3">
        <div className={cn("h-10 w-10 rounded-xl flex items-center justify-center transition-smooth group-hover:scale-110", toneMap[tone])}>
