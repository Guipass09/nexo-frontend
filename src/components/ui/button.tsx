  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-55 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border/80 bg-white/75 text-foreground shadow-sm backdrop-blur hover:border-primary/35 hover:bg-white hover:text-primary",
        secondary: "border border-border/70 bg-secondary/80 text-secondary-foreground shadow-sm hover:bg-secondary",
        soft: "border border-primary/15 bg-primary/10 text-primary shadow-sm hover:bg-primary/15",
